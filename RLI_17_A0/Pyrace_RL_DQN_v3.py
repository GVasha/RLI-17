...
if __name__ == "__main__":
    ...
    STATE_DIM   = int(np.prod(env.observation_space.shape))  # 5
    NUM_ACTIONS = env.action_space.n                          # 4  (added BRAKE)
    ...
    NUM_EPISODES   = 2_000 #decreased for testing purposes
    MAX_T          = 2000
    BATCH_SIZE     = 64
